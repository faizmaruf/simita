...
class M_printer extends CI_Model {   
    ...
    function getAllPrinters(){
        return $this->db->query("SELECT tb_inv_printer.*,tb_pengguna.nama_pengguna FROM tb_inv_printer LEFT JOIN tb_pengguna ON tb_inv_printer.id_pengguna=tb_pengguna.id_pengguna ");
    }

    function semua() {
        $gid=$this->session->userdata('gid');
        $query = $this->db->query("SELECT tb_cabang.namacabang,tb_inv_printer.merk,tb_inv_printer.id_printer,tb_inv_printer.no_inventaris,tb_pengguna.nama_pengguna,tb_inv_printer.jenis_printer,
            ...
            LEFT JOIN tb_pengguna ON tb_pengguna.id_pengguna = tb_inv_printer.id_pengguna
    ...
    function semuagid() {
        $gid=$this->session->userdata('gid');
        $query = $this->db->query("SELECT tb_cabang.namacabang,tb_inv_printer.merk,tb_inv_printer.isSewa,tb_inv_printer.id_printer,tb_inv_printer.no_inventaris,tb_pengguna.nama_pengguna,tb_inv_printer.jenis_printer,
            ...
            FROM tb_inv_printer INNER JOIN 
             ON tb_pengguna.id_pengguna = tb_inv_printer.id_pengguna 
            INNER JOIN tb_cabang ON tb_cabang.id_cabang = tb_pengguna.id_cabang
    ...
    function semua_arsip() {
        $gid=$this->session->userdata('gid');
        $query = $this->db->query("SELECT tb_inv_printer.id_printer,tb_inv_printer.isSewa,tb_inv_printer.no_inventaris,tb_pengguna.nama_pengguna,tb_inv_printer.jenis_printer,
    ...
    function semuagid_arsip() {
        $gid=$this->session->userdata('gid');
        $query = $this->db->query("SELECT tb_inv_printer.id_printer,tb_inv_printer.no_inventaris,tb_pengguna.nama_pengguna,tb_inv_printer.jenis_printer,
            tb_inv_printer.spesifikasi,tb_inv_printer.tgl_inv,tb_inv_printer.status,tb_inv_printer.note,tb_inv_printer.gid,tb_departemen.nama,tb_departemen.parent,tb_pengguna.id_dept
            FROM tb_inv_printer INNER JOIN tb_pengguna ON tb_pengguna.id_pengguna = tb_inv_printer.id_pengguna 
